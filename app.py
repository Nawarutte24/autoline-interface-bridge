...
UNIFIED_ARCODE_BY_DEALERPRO = {
    ...
    "1625": "A0025",  # บริษัท มาสเตอร์ คาร์เร้นเทิล เซอร์วิส จำกัด
    "2419": "A0025",  # บริษัท มาสเตอร์ คาร์เร้นเทิล จำกัด
    "1503": "A0025",  # มาสเตอร์ คาร์ เร้นเทิล จำกัด
...
UNIFIED_CUSTOMER_ENTRIES = [
    ...
    ("M0012", "บริษัท มาสเตอร์ มอเตอร์ เซอร์วิสเซส (ประเทศไทย) จำกัด", ["มาสเตอร์ มอเตอร์ เซอร์วิสเซส", "มาสเตอร์ มอเตอร์", "master motor", "mms"]),
    ("A0025", "บริษัท มาสเตอร์ คาร์เร้นเทิล จำกัด", ["มาสเตอร์ คาร์เร้นเทิล", "มาสเตอร์ คาร์ เร้นเทิล", "มาสเตอร์ คาร์เร้นเทิล เซอร์วิส", "master car rental"]),
...
def resolve_unified_arcode(dealerpro_code=None, customer_name=None, context="aftersale", default_override=None):
    ...
    if c and c != "nan" and c != "none":
        ...
        # Master Car Rental (A0025) vs Master Motor Services (M0012)
        # A0025: บริษัท มาสเตอร์ คาร์เร้นเทิล จำกัด (Car Rental / รถเช่า - รวมชื่อที่มี 'คาร์เร้นเทิล เซอร์วิส')
        # M0012: บริษัท มาสเตอร์ มอเตอร์ เซอร์วิสเซส (ประเทศไทย) จำกัด (MMS / Motor Services / ศูนย์บริการ)
        c_compact = c.replace(" ", "")
        if "คาร์เร้นเทิล" in c_compact or "carrental" in c_compact or ("master" in c and "rental" in c) or ("มาสเตอร์" in c and "เร้นเทิล" in c):
            return "A0025"
        if "มาสเตอร์มอเตอร์" in c_compact or "mastermotor" in c_compact or "mms" in c or "mmsbosch" in c_compact or ("มาสเตอร์" in c and "มอเตอร์" in c):
            return "M0012"
